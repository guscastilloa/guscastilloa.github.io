...
Apart from the Young Scholars Initiative working group Philosophy of Economics and the ReplicationWiki that we will introduce in this session, the webinar series was prepared with the [Project Teaching Integrity in Empirical Research (TIER)](https://projecttier.org) that will be described in the next session.
...
The [Institute for New Economic Thinking (INET)](https://www.ineteconomics.org/) was founded after the global financial crisis. Apart from sponsoring research and organizing events it also set up the [Young Scholars Initiative (YSI)](https://ysi.ineteconomics.org/) because the next generation of researchers was seen as pivotal for not only coming up with ideas for new economic thinking but especially for sustainably putting them into practice. It is structured into [working groups](https://ysi.ineteconomics.org/workinggroups) with regional or thematic focus like for [South](https://ysi.ineteconomics.org/workinggroup/south-asia) or [East Asia](https://ysi.ineteconomics.org/workinggroup/east-asia), [Africa](https://ysi.ineteconomics.org/workinggroup/africa), [Europe](https://ysi.ineteconomics.org/workinggroup/political-economy-of-europe), \[Northern\] and [Latin America](https://ysi.ineteconomics.org/workinggroup/latin-america), [Economic Development](https://ysi.ineteconomics.org/workinggroup/economic-development), [History of Economic Thought](https://ysi.ineteconomics.org/workinggroup/history-of-economic-thought) or [Sustainability](https://ysi.ineteconomics.org/workinggroup/sustainability), [Inequality](https://ysi.ineteconomics.org/workinggroup/inequality), or [Finance, Law and Economics](https://ysi.ineteconomics.org/workinggroup/finance-law-and-economics). Anyone can freely choose to join these groups and have a say on what they should focus on. Our group for [Philosophy of Economics](https://ysi.ineteconomics.org/workinggroup/philosophy-of-economics) has organized ongoing groups for discussion and presentation of our research, or research we are interested in, for writing, for peer review, on feminist epistemology, we had workshops, and [participated](https://ysi.ineteconomics.org/project/62723818f6ac274b794bdbbb/event/62723ed8f6ac274b794bddd5) in events like the [Turin Festival of Economics](https://www.festivalinternazionaledelleconomia.com).
...
A professor’s (Andrés Moya, Uniandes) presentation on a failure to replicate a study on dishonesty ([Dan Ariely et al's 2012 PNAS study](https://doi.org/10.1073/pnas.1209746109)) during the same class where I ran my first experiment pointed me to the irony and misfortune of dishonesty in an article regarding dishonesty. The question bounces back to us, how to assess dishonesty, but not in a insurance policy context, but in research contexts?
...
Then I found out my PhD supervisor had his student assistants edit Wikipedia articles to promote his research and he did not even admit that this breaks rules on conflicts of interest[^3] and paid editing[^4] and obviously any common sense principle of how an encyclopedia should be written. So I had to search for a new supervisor - but that's a different story.  
...
### The website [Find Economic Articles with Data](https://ejd.econ.mathematik.uni-ulm.de/)...
...
directly. The ReplicationWiki offers a [list of journals that keep such archives](https://replication.uni-goettingen.de/wiki/index.php/Journal_publication_policies). It is great if you can find additional journals whose archives should be listed. It is a wiki, so just go ahead and add them. Another potential place where you can find replication material is
...
<a href="http://replication.uni-goettingen.de/wiki_DEV/index.php/User:Gustavo_Adolfo_Castillo_Alvarez" class="wikilink" title="Gustavo A. Castillo Alvarez">Gustavo A. Castillo Alvarez</a> has been working in a project to fight disinformation in Colombia (Detox Information Project) since 2021, and studies political science and economics at Universidad de los Andes where he participated in the Complexity Economics Research group. He had the idea to start this webinar series in the YSI working group Philosophy of Economics.

<a href="http://replication.uni-goettingen.de/wiki_DEV/index.php/User:Jan_H._Höffler" class="wikilink" title="Jan H. Höffler">Jan H. Höffler</a> founded the ReplicationWiki in 2013 during his PhD in economics at the University of Göttingen after studies at Mannheim University, Humboldt-University of Berlin and exchange programs at University of Toronto and Graduate Institute, Geneva. He has presented about replication at numerous <a href="http://replication.uni-goettingen.de/wiki_DEV/index.php/User:Jan_H._H%C3%B6ffler#Conference_presentations_related_to_ReplicationWiki" class="wikilink" title="conferences">conferences</a> and as <a href="http://replication.uni-goettingen.de/wiki_DEV/index.php/User:Jan_H._H%C3%B6ffler#Invited_presentations" class="wikilink" title="invited speaker">invited speaker</a> internationally, published about the topic in the *[American Economic Review Papers and Proceedings](https://ideas.repec.org/a/aea/aecrev/v107y2017i5p52-55.html)* and *[D-Lib Magazine](http://www.dlib.org/dlib/march17/hoeffler/03hoeffler.html)* and has been <a href="http://replication.uni-goettingen.de/wiki_DEV/index.php/User:Jan_H._H%C3%B6ffler#Replication_courses_taught" class="wikilink" title="teaching replication">teaching replication</a> at various German universities, University of Toronto, Graduate Institute, Geneva, Nanjing University, and United Nations University in Maastricht since 2008.

<a href="http://replication.uni-goettingen.de/wiki_DEV/index.php/User:DianaSoeiro" class="wikilink" title="Diana Soeiro">Diana Soeiro</a>, scientific writer and policy analyst, currently hosted at ISCTE-Lisbon University Institute. PhD in Philosophy and Urban Studies (2011); Post-Grad in Economics and Public Policy (2018). My most recent book [Cities, Health and Wellbeing: Global governance and intersectoral policies (Palgrave 2022)](https://10.1007/978-3-030-89348-4) emphasizes the role of urban design, innovative governance strategies and intersectoral policies. I am co-coordinator of the 'Philosophy of Economics' Working Group at YSI-Institute for New Economic Thinking (New York, USA). In 2017, I was appointed Honorary Ambassador for United Nations 2030 Agenda for Sustainable Development Goals (UN Global Compact Network, Portugal).

## References

<a href="http://replication.uni-goettingen.de/wiki_DEV/index.php/Category:Webinar_series" class="wikilink" title="Category:Webinar series">Category:Webinar series</a>
...
[^2]: “Viewpoint: Replication in Economics”, Daniel S. Hamermesh, *Canadian Journal of Economics* 2007, 40(3), 715-733. DOI: [10.1111/j.1365-2966.2007.00428.x](https://doi.org/10.1111/j.1365-2966.2007.00428.x)

[^3]: [Rules on Conflict of interest in the English version of Wikipedia](https://en.wikipedia.org/wiki/Wikipedia:Conflict_of_interest)

[^4]: [Rules on Paid editing in the English version of Wikipedia](https://en.wikipedia.org/wiki/Wikipedia:Paid_editing)

[^5]: [Sustainable Development Goal 16 of the United Nations Department of Economic and Social Affairs](https://sdgs.un.org/goals/goal16)

[^6]: "Does high public debt consistently stifle economic growth? A critique of Reinhart and Rogoff", Thomas Herndon, Michael Ash, Robert Pollin, *Cambridge Journal of Economics* 2014, 38(2), 257–279. DOI: [10.1093/cje/bet075](https://doi.org/10.1093/cje/bet075)

[^7]: [Thomas Herndon on the list of faculty at the John Jay College Graduate Program in Economics at the City University of New York](https://johnjayeconomics.org/faculty)

[^8]: [Carmen M. Reinhart's profile on the website of the World Bank](https://www.worldbank.org/en/about/people/c/carmen-reinhart)

[^9]: [Carmen M. Reinhart's profile on the website of the Harvard Kennedy School](https://www.hks.harvard.edu/faculty/carmen-reinhart)

[^10]: In "Introducing a replication section", Hashem Pesaran, *Journal of Applied Econometrics* 2003, 18(1), 111. DOI: [10.1002/jae.709](https://doi.org/10.1002/jae.709) it is also suggested to use alternative computer packages and the *Journal of Applied Econometrics* started a mandatory data archive back in 1995 [1](http://qed.econ.queensu.ca/jae/) but does not oblige its authors to share their code.

[^11]: Curiously, Pesaran in his above mentioned 2003 text only mentioned the use of new data although many of the replications published in the *Journal of Applied Econometrics*' replication section use new methods as well, e.g., "Did Protestantism promote prosperity via higher human capital? Replicating the Becker–Woessmann (2009) results", Jeremy Edwards, *Journal of Applied Econometrics*, 2021, 36(6), 853-858. DOI: [10.1002/jae.2851](https://doi.org/10.1002/jae.2851), "The frequency of visiting a doctor: Is the decision to go independent of the frequency?", Hans Van Ophem, *Journal of Applied Econometrics*, 2011, 26(5), 872-879. DOI: [10.1002/jae.1252](https://doi.org/10.1002/jae.1252) or check the [list of this journal's replications covered in the ReplicationWiki](https://replication.uni-goettingen.de/wiki/index.php?title=Special:Ask&q=%5B%5BCategory%3AReplication%5D%5D%5B%5BArticle+journal%3A%3A%7E%2AJournal+of+Applied%2A%5D%5D&p=format%3Dbroadtable%2Flink%3Dall%2Fheaders%3Dshow%2Fsearchlabel%3D%E2%80%A6-20further-20results%2Fclass%3Dsortable-20wikitable-20smwtable&po=%3FArticle+journal%0A%3FArticle+year%0A%3FArticle+data%0A%3FArticle+program+code%0A%3FArticle+data+used%0A%3FArticlejel%0A%3FArticlekeywords%0A%3FArticle+software+used%0A%3FArticle+methods+and+estimation%0A%3FArticle+data+used%0A%3FArticle+origin+of+data+used%0A%3FReplication+type%0A%3FReplication+result%0A%3FReplication+raw+data%0A%3FReplication+call+into+question%0A%3FReplication+authors+statement%0A&sort=&order=asc&eq=no&offset=0&limit=500), many of which are categorized as using new methods.

[^12]: “The Statistics Wars and Their Casualties”, [<https://phil-stat-wars.com>](https://phil-stat-wars.com), is a webinar series that covers the discussion on the use of statistical significance for inference.

[^13]: Collecting a list of examples of this malpractice would not make us friends but illustrate the problem.

[^14]: "Is newer better? Penn World Table Revisions and their impact on growth estimates", Simon Johnson, William Larson, Chris Papageorgiou, Arvind Subramanian, *Journal of Monetary Economics* 60(2) 2013, 255-274. DOI: [10.1016/j.jmoneco.2012.10.022](https://doi.org/10.1016/j.jmoneco.2012.10.022)

[^15]: "Risk Sharing in Village Economies Revisited", Tessa Bold, Tobias Broer, *Journal of the European Economic Association*, 2021, 19(6), 3207–3248. DOI: [10.1093/jeea/jvab043](https://doi.org/10.1093/jeea/jvab043)

[^16]: "Is Economics Research Replicable? Sixty Published Papers From Thirteen Journals Say “Often Not”", Andrew C. Chang and Phillip Li, *Critical Finance Review*, 2022, 11(1), 185-206. DOI: [10.1561/104.00000053](http://dx.doi.org/10.1561/104.00000053)

[^17]: "[No comment, please - Steven Levitt blocks an undesired statement](https://www.handelsblatt.com/politik/konjunktur/oekonomie/nachrichten/steven-levitt-blocks-an-undesired-statement-no-comment-please/2976444.html)", Häring, Nobert, *Handelsblatt*, 2008. “[Hepatitis B and missing women: The rise and decline of a finding](https://cepr.org/voxeu/columns/hepatitis-b-and-missing-women-rise-and-decline-finding)”, Klasen, Stephan, *VoxEU*, 2008.

[^18]: [What Has Been Learned from the Deworming Replications: A Nonpartisan View](http://www.columbia.edu/~mh2245/w/worms.html)”, Humphreys, Macartan, 2015, Columbia University

[^19]: “The Colonial Origins of Comparative Development: An Empirical Investigation: Reply”, Acemoglu, Daron, Simon Johnson and James A. Robinson, *American Economic Review*, 2012, 102(6), 3077-3110. DOI: [10.1257/aer.102.6.3077](https://doi.org/10.1257/aer.102.6.3077)

[^20]: "[She sent a letter pointing out problems with a published article, the reviewers agreed that her comments were valid, but the journal didn’t publish her letter because “the policy among editors is not to accept comments.”](https://statmodeling.stat.columbia.edu/2021/07/08/she-sent-a-letter-pointing-out-problems-with-a-published-article-the-reviewers-agreed-that-her-comments-were-valid-but-the-journal-didnt-publish-her-letter-because-the-policy-among-editors-is-no/)", Statistical Modeling, Causal Inference, and Social Science blog, Andrew Gelman, July 8, 2021

[^21]: [Replications published in the *Economic Journal*](https://replication.uni-goettingen.de/wiki/index.php/Special:BrowseData/Replication?title=Special%3ABrowseData%2FReplication&_search_Journal%5B0%5D=%5B%5B%3ACategory%3AEJ%7CEJ%5D%5D)

[^22]: We thank Michael Ash for his comment on an earlier work ("[Teaching Replication in Quantitative Empirical Economics](https://ideas.repec.org/p/stg/wpaper/2014_02.html)", Jan H. Höffler, *Replication Working Paper Series* 2014) that he disrecommends pre-selecting studies for replications by students as in his long experience employing replication in his teaching he identified interest in the topic as the most important factor for successful work.

[^23]: On the left of each ReplicationWiki page you find a link to the help pages. This particular one has the following link: <a href="http://replication.uni-goettingen.de/wiki_DEV/index.php/ReplicationWiki:Help/Editing#How_can_I_start_a_new_page?" class="wikilink" title="ReplicationWiki:Help/Editing#How can I start a new page?">ReplicationWiki:Help/Editing#How can I start a new page?</a>

---

*This page mirrors the archived [ReplicationWiki session page](http://replication.uni-goettingen.de/wiki_DEV/index.php/Webinar_Series_Introduction:_Why_replication%3F_How_is_it_done%3F_Where_to_find_replication_material%3F). The source text is preserved in full; only headings, link formatting, typography, and page structure have been adapted for this site.*
