---
layout: page
title: "Advice and Information on Computational Reproductions: Students May Find Them Messier Than Expected"
permalink: /projects/replicaiton_webinar/sessions/04-computational-reproductions/
description: "Nate Breznau, University of Bremen — October 13, 2022"
nav: false
---
...
Use the <a href="http://replication.uni-goettingen.de/wiki_DEV/index.php/Talk:Webinar_series:_Advice_and_Information_on_Computational_Reproductions:_Students_May_Find_Them_Messier_Than_Expected" class="wikilink" title="discussion page">discussion page</a> to comment or ask questions in written form.  
...
*This page mirrors the archived [ReplicationWiki session page](http://replication.uni-goettingen.de/wiki_DEV/index.php/Webinar_series:_Advice_and_Information_on_Computational_Reproductions:_Students_May_Find_Them_Messier_Than_Expected). The source text is preserved in full; only headings, link formatting, typography, and page structure have been adapted for this site.*
