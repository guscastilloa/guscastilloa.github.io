...
*This page mirrors the archived [ReplicationWiki session page](http://replication.uni-goettingen.de/wiki_DEV/index.php/Webinar_series:_Questionable_research_practices_outside_of_the_lab). The source text is preserved in full; only headings, link formatting, typography, and page structure have been adapted for this site.*
